...
ActiveRecord::Schema[8.1].define(version: 2026_07_07_120000) do
  ...
  create_table "experiment_assignments", force: :cascade do |t|
    ...
    t.bigint "experiment_variant_id", null: false
  ...
  create_table "experiment_conversions", force: :cascade do |t|
    ...
    t.bigint "experiment_assignment_id", null: false
  ...
  create_table "outbound_events", force: :cascade do |t|
    ...
    t.bigint "replayed_from_outbound_event_id"
  ...
  create_table "tickets", force: :cascade do |t|
    ...
    t.check_constraint "length(inbox::text) > 0 AND length(inbox::text) <= 64", name: "tickets_inbox_length"
